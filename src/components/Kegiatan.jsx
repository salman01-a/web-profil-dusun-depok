...
const KEGIATAN = [
  ...
  { title: 'Latihan Koncer', jadwal: 'Malam Kamis & Minggu', category: 'Kesenian', desc: 'Latihan rutin kelompok kesenian dusun untuk melestarikan tarian tradisional Koncer, diikuti para ibu-ibu dan warga dengan penuh semangat.', imgLabel: <img src={LatihanKoncer} alt="Latihan Koncer" /> },
